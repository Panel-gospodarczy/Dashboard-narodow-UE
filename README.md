...
Współpraca z bazą danych Eurostat

 |

Integracja z bazą danych Eurostat\
w celu pobrania aktualnych danych gospodarczych.
...
Wyświetlanie interaktywnej mapy z podziałem na kraje UE.
...
Ranking prezentujący bogactwo narodów według wskaźnika kompozytowego.
...
Podsumowanie wskaźników bogactwa z podziałem na kraje.
...
Wykresy wskaźników gospodarczych\
...
Wizualizacja wskaźników gospodarczych Polski w latach 2012-2023.
...
Program musi odpowiedzieć na zapytanie w czasie X sekund.
...
System jest dostępny w 100% czasu jego pracy.
...
Zgodność z przepisami o danych publicznych

 |

Aplikacja przestrzega przepisów o udostępnianiu danych publicznych, takich jak otwarte dane.
...
Aplikacja działa\
w popularnych przeglądarkach internetowych (Chrome, Edge, Firefox, Safari).
...
System niesie za sobą wartość poznawczą\
i edukacyjną.
...
Aplikacja wykorzystuje odpowiednią paletę kolorów.
